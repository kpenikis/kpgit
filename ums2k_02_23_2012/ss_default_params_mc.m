...
%
 ...
 %  spikes.params.thresh =    [-5.3897 -5.0999 -5.1816 -5.5274]; % for 'manual', set specific thresholds for each channel
    ...
    spikes.params.agg_cutoff = 0.05;         %  higher = less aggregation, lower = more aggregation. Default is 0.05. 
    spikes.params.kmeans_clustersize = 2000; %  target size for miniclusters %default is 500, MLC changed to 2000.
    ...
    % plot_waveforms
    spikes.params.display.default_waveformmode = 1;  % 1 = show all waveforms, 2 = show 95% waveform bands, 3 = show 2d histogram
    ...
    spikes.params.display.figure_font_size = 12;  % default font size 
