...
q=load(fullfile(savedir,'CTTS_Speech_nonSim')); %Cell_Time_Trial_Stim
...
for ii = 1:numel(WinEnds)
    ...
    for iUn = 1:size(CTTS,1)
        ...
        % Save figure
        savedir = fullfile(fn.figs,'ClassSpeech',whichStim,varPar,whichCells);
