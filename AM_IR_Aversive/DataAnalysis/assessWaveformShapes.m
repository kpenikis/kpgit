...
%     print_eps_kp(hf1,fullfile(savedir,FigSavename))
    ...
    AllBaselineFRs(AllBaselineFRs<0.1) = 0.1;
    
    hf2 = figure;
    hold on
    plot(AllBaselineFRs', UnitInfo.TroughPeak','.','Color',0.12*[1 1 1],'MarkerSize',20)
    % scatter(UnitInfo.WidthHalfMax', UnitInfo.TroughPeak', 300,'k')
    axis square
    set(gca,'xlim',[0.1 40],'ylim',[0.1 0.9],'xscale','log')
    ...
    print_eps_kp(hf2,fullfile(savedir,FigSavename))
