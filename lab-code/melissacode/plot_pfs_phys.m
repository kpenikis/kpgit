...
%plot_pfs_phys(directoryname,figuredirectory)
%
...
%
%animalIDs: cell array of animal IDs to include in analysis
%
...
for which_day = 1:numel(days)
    ...
    for which_animal = 1:numel(animals)
        ...
        for which_file = 1:numel(files)
            ...
            %Only bother fitting data from active sessions. (There is no
            %behavior from passive sessions)
