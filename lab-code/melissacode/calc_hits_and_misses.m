function [output,varargout] = calc_hits_and_misses(stimuli,resps)
%output = calc_hits_and_misses(stimuli,resps)
%
...
%have a ceiling of 95%, and false alarm rates have a floor of 5%.
%
%Input variables:
